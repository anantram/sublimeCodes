...
If there is no path from source vertex to v1, print its distance from source to v1 in the format as s->v1:99999, 
otherwise print its path from source to v1 and its distance.
...
class bellmanford {
	public static void main(String[] args) {
		...
		while (!nodeQueue.isEmpty()) {
			...
			for(int i = 0; i < numberOfNodes; i++) {
				if (pathArray[i][temp.position] != 0) {
